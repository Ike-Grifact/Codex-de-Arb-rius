...
6. Princípio da Linhagem
7. Termos usados no guia
...
O animal não é escolhido como uma peça perfeita para a construção do personagem. Ele é selecionado antes da Partida a partir de linhagem, temperamento, treinamento, histórico e compatibilidade possível com o portador.

A Guilda dos Exploradores, a Guilda dos Criadores, os Alquimistas e os Instrutores participam desse processo. Ainda assim, nenhuma seleção elimina completamente medo, incompatibilidade, dor, preferência ou vontade própria.

O Campeiro possui ficha, Saúde, Aptidões, Características, comportamento, necessidades e mutações. Ele pode cooperar, hesitar, resistir, aprender, adoecer, sofrer e mudar.
...
| **Esforço** | Trilha física do Campeiro, de 0 a 5. |
...
O personagem é criado normalmente pelas regras de Assimilação RPG.

### 8.1. Elementos obrigatórios da temporada
...
A ficha inicial do Campeiro é preparada pelo Assimilador considerando linhagem, temperamento, treinamento, medos, preferências, função anterior e possível compatibilidade com o portador.

Depois da Partida, o jogador passa a administrar a ficha e as decisões habituais do animal.

### 10.1. Instintos

O Campeiro possui seis Instintos:
...
Todos começam no nível 1. Distribua mais:

> **3 pontos entre os Instintos.**
...
Todos começam no nível 0. Distribua:

> **3 pontos totais compartilhados entre todos os Conhecimentos e Práticas.**
...
O Campeiro começa com:

> **2 pontos de Características.**

Pode adquirir Características de Infectados quando:

- os requisitos forem cumpridos;
- a biologia do cavalo permitir;
- a função puder ser adaptada à anatomia equina;
...
- uso das Aptidões;
- equipamento e carga;
- desenvolvimento por Experiência;
- riscos voluntariamente assumidos.

O Assimilador decide reações involuntárias ligadas a:
...
| Esforço | Estado | Efeito |
|---:|---|---|
| 0 a 2 | Operacional | sem penalidade |
| 3 a 4 | Cansado | reduz a pilha equina em um dado, mínimo de um |
| 5 | Exausto | não fornece dado adicional; não suporta carga pesada nem combate montado |

O Campeiro pode ganhar Esforço por viagem severa, marcha forçada, carga pesada, privação, perseguição prolongada ou Pressões físicas.

Recuperação recomendada:

- pausa segura com água: reduz Esforço em 1;
- repouso completo com alimento, água e descarga: reduz Esforço em 3.
...
A capacidade de carga do Campeiro é:

> **20 Espaços + 2 Espaços para cada ponto de Potência acima de 1.**
...
- montador adulto: 10 Espaços;
- segundo adulto ou pessoa inconsciente: aproximadamente 10 Espaços;
- criança ou criatura pequena: aproximadamente 5 Espaços;
- sela, manta, cilha, cabeçada e rédeas básicas: não ocupam Espaços;
- versões reforçadas, blindadas ou assimiladas ocupam Espaços conforme equipamento;
- alforjes organizam a carga, mas não aumentam a capacidade.

### 13.1. Faixas de carga

- até 75% da capacidade: operação normal;
- acima de 75% até o máximo: carga pesada;
- acima do máximo: sobrecarga, sujeita a recusa, dano e perda de movimento.

### 13.2. Proteções equinas

| Equipamento | Espaços sugeridos |
|---|---:|
| Armadura leve | 2 |
| Armadura média | 4 |
| Armadura pesada | 6 |
...
1. Declare a participação do Campeiro antes da rolagem.
2. Confirme que movimento, terreno, treinamento e estado do animal são compatíveis.
3. O portador monta sua pilha normalmente.
4. O Campeiro rola a Aptidão equina relevante.
...
A contribuição do Campeiro é apropriada em ações como:
...
- reconhecimento em movimento;
- transporte de feridos;
- deslocamento de carga.

Ela não se aplica automaticamente a ações que dependam apenas de conhecimento, fala, mãos, ferramentas ou decisões humanas sem participação física do animal.

## 15. Campeiro desmontado

### 15.1. Narrativa Fluida

Fora de Conflito, o Arboriano pode instruir o Campeiro a:

- ficar;
- seguir alguém;
- retornar;
- procurar água ou alimento;
- explorar uma direção;
- aguardar em um ponto;
- vir quando chamado.

Comandos simples, conhecidos e seguros normalmente não consomem uma ação rígida e não exigem teste.
...
Sem um comando específico, o Campeiro pode:

- seguir ordem anterior;
- acompanhar o portador;
- procurar cobertura;
- proteger a si mesmo;
- recuar;
- fugir;
...
O Assimilador decide a resposta conforme personalidade, treinamento, dor, Alarme e situação.
...
- mudança de direção;
- perda de posição;
- aumento de Esforço ou Alarme.

### 16.2. Consequências da queda

Quando ocorre uma queda:

- o deslocamento termina;
- portador e Campeiro tornam-se alvos separados;
- ambos podem perder posição;
- equipamentos podem ficar Danificados;
- carga pode se espalhar;
- ambos podem sofrer dano.

Dano sugerido quando a cena não definir outro valor:
...
Quando o portador entra em Estado Suscetível e realiza um Teste de Assimilação, o Campeiro participa pela Ressonância.
...
### 17.2. Janela de Troca Ressonante

Antes de gastar os resultados, a dupla pode trocar cartas reveladas naquela manifestação.

Regras:

- somente cartas reveladas naquele processo podem ser trocadas;
- cartas antigas, fixadas, compradas ou dormentes ficam fora da troca;
- a troca precisa manter o mesmo naipe ou categoria;
- Evolutiva troca com Evolutiva;
- Adaptativa troca com Adaptativa;
- Inoportuna troca com Inoportuna;
...
- cada corpo paga suas cartas com os próprios resultados;
- cartas podem possuir custos diferentes;
- resultados nunca são transferidos;
- mutações fixadas pertencem permanentemente ao corpo que as pagou.
...
O Campeiro recebe no máximo:

> **1 ponto de Experiência por sessão em que participe significativamente.**

Essa Experiência é separada e não reduz a recompensa do portador. Pontos não gastos acumulam sem prazo.

### 18.1. Características adicionais

Depois da criação, o Campeiro pode adquirir novas Características compatíveis de Infectados pelo custo impresso de 1, 2 ou 3 pontos de Experiência.

Não existe limite numérico fixo de Características, mas toda compra exige requisitos, compatibilidade biológica, justificativa narrativa e aprovação do Assimilador.

Estágio Avançado permanece uma decisão exclusiva da criação.

### 18.2. Conhecimentos e Práticas

Custo para alcançar o novo nível:

> **2 vezes o nível desejado.**
...
Regra adaptada para o Campeiro:

> **3 vezes o nível desejado.**
...
O Arboriano é especialmente eficiente em:
...
- reconhecimento;
- proteção de rotas;
- organização de equipamento;
- ações nas quais portador e Campeiro podem trabalhar sobre o mesmo Objetivo.
...
Antes de uma cena social importante, pergunte:

1. O personagem conhece essa cultura?
2. Existe alguém no grupo capaz de orientar?
3. É possível observar antes de agir?
4. O Campeiro, equipamento ou aparência Arboriana pode produzir medo ou prestígio?
5. Qual erro cultural seria mais perigoso nesta situação?

Ações úteis:

- pedir explicação a um aliado;
- usar Percepção para observar reações;
- usar Sagacidade para reconhecer padrões;
- evitar promessas cujo significado local seja desconhecido;
- registrar nomes, gestos e regras descobertas;
- assumir responsabilidade quando um mal-entendido ocorrer.
...
- o que assusta o animal;
- quais comandos ele conhece;
- como reage a estranhos;
- que tipo de descanso prefere;
- quais sinais físicos apresenta antes de recusar;
...
- valor real do Objetivo.

## 23. Viagem e logística

O Campeiro permite que o grupo transporte mais, mas não elimina decisões de inventário.

### 23.1. Antes da viagem

Verifique:

- água e alimento do animal;
- condição dos cascos;
- encaixe da sela e da cilha;
- peso total;
- itens frágeis;
- acesso rápido a ferramentas e armas;
- rota de descanso;
- terreno incompatível;
- quem cuida do Campeiro caso o portador fique ferido.

### 23.2. Distribuição de carga

Não use toda a capacidade apenas porque ela existe. Espaço livre permite:

- transportar feridos;
- recolher recursos;
- redistribuir equipamento;
- reduzir Esforço;
- responder a emergências.

Carga excessiva transforma a maior vantagem do Arboriano em uma fonte constante de Pressões.

## 24. Decisões em Conflito

### 24.1. Permanecer montado

É vantajoso quando:

- o terreno permite movimento;
- o Objetivo depende de posição ou velocidade;
- o Campeiro não está Alarmado ou Exausto;
- existe espaço para manobra;
- a carga está segura;
- a queda não colocará aliados em risco desproporcional.

### 24.2. Desmontar

É prudente quando:

- há corredores estreitos;
- o piso é instável;
- o inimigo pode atingir o animal facilmente;
- o Campeiro precisa proteger carga ou retirada;
- a cena exige mãos, fala ou precisão humana;
- o Alarme está subindo;
- o personagem precisa evitar que uma queda atinja ambos.

### 24.3. Comandar separadamente

Gastar a ação para comandar o Campeiro faz sentido quando a ação do cavalo é mais valiosa que a ação direta do portador.

Exemplos:

- retirar um aliado inconsciente;
- bloquear uma passagem;
- carregar uma mensagem;
- romper uma formação;
- fugir com equipamento essencial;
- atrair uma criatura para outra direção.

## 25. Ressonância e mutações

Durante a Manifestação Ressonante, avalie cada carta segundo o corpo que realmente poderá utilizá-la.
...
Não trate o Campeiro como depósito de Inoportunas. Ele possui seu próprio limite Feral e pode ser perdido para a Assimilação.

## 26. Erros comuns

### Usar o Campeiro como segundo turno

Montado, existe uma única Ação Conjunta. Desmontado, um comando específico em Conflito consome a ação do Arboriano.

### Declarar o dado equino depois da rolagem

A participação precisa ser declarada antes. O dado escolhido deve ser mantido.

### Ignorar Pressões do cavalo

As Pressões equinas afetam primeiro animal, posição, carga e equipamento. Elas não desaparecem por fazerem parte de uma ação compartilhada.

### Presumir conhecimento cultural

Ser de Árborius não concede entendimento automático de todas as comunidades. Use a campanha para aprender.

### Levar o cavalo a toda cena

Nem todo ambiente comporta uma montaria. Planejar onde deixá-la e como protegê-la também é gameplay.

### Escolher mutações apenas pelo efeito numérico

Mutações alteram anatomia, equipamentos, cuidados e relação com outras pessoas. A ficha deve refletir essas consequências.

## 27. Exemplos completos

### 27.1. Primeiro contato cultural

O grupo chega a uma comunidade em que entregar uma arma ao anfitrião é sinal de confiança. O Arboriano desconhece o costume e permanece armado.

O Assimilador não aplica uma penalidade automática. Como o costume é central, exige um teste para perceber a tensão antes que a conversa avance.

O personagem pode:

- observar outros visitantes;
- perguntar ao aliado;
- explicar sua hesitação;
- aceitar o ritual;
- recusar e enfrentar as consequências sociais.

Depois de convivência significativa, essa comunidade pode ser registrada como Cultura Aprendida.

### 27.2. Ação Conjunta Montada

O Arboriano tenta atravessar uma linha inimiga para alcançar uma saída.
...
### 27.3. Comando desmontado

O portador precisa manter uma porta enquanto ordena ao Campeiro que retire um aliado.

Em Conflito, não pode fazer as duas ações completas na mesma rodada.
...
6. o portador não realiza outra ação naquela rodada.
...
### 28.1. Criação do Campeiro

| Elemento | Valor inicial |
|---|---|
| Instintos | todos 1, mais 3 pontos, máximo inicial 3 |
| Conhecimentos e Práticas | 3 pontos totais compartilhados, máximo inicial 2 |
...
1. Declare antes da rolagem.
2. Role a Aptidão equina relevante.
3. Escolha um dado equino.
4. Mantenha obrigatoriamente esse dado.
5. Conte-o no limite normal.
6. Aplique Pressões primeiro ao Campeiro.
7. Não realize segunda ação.

### 28.3. Ação desmontada em Conflito
...
### 28.4. Estados do Campeiro

| Trilha | Faixas principais |
|---|---|
| Esforço | 0 a 2 Operacional; 3 a 4 Cansado; 5 Exausto |
| Alarme | 0 Calmo; 1 Inquieto; 2 Alarmado; 3 Pânico |

### 28.5. Fluxo da dupla

| Situação | Procedimento |
|---|---|
| Montado, mesmo Objetivo | Ação Conjunta com um dado equino mantido |
| Desmontado, Narrativa Fluida | comandos simples sem economia rígida; teste apenas com incerteza real |
| Desmontado, Conflito | Influência + Sobrevivência consome a ação do Arboriano |
| Sem comando | Campeiro segue treino, ordem anterior ou instinto sob controle do Assimilador |
| Muitas Pressões montadas | instabilidade, queda, dano ou avaria |
| Estado Suscetível do portador | Manifestação Ressonante com rolagens separadas |

## Fechamento da temporada

A Linhagem Arboriana combina duas dificuldades diferentes: a convivência com culturas externas e a responsabilidade por um Campeiro Ressonante.

O personagem começa isolado, mas não precisa permanecer incapaz de pertencer. O Campeiro começa treinado, mas não precisa permanecer apenas obediente. A primeira temporada deve registrar como a dupla muda quando deixa Árborius, encontra outras comunidades e precisa decidir quais hábitos conservar, quais abandonar e quais compreender antes de julgar.

---

**Base mecânica:** Assimilação RPG e módulo Campeiro Explorador do Codex de Árborius.

**Escopo:** guia de jogador da primeira temporada. Segredos de campanha e informações do Assimilador permanecem fora deste documento.
